...
with gr.Blocks(title="Market Mentor") as demo:
    ...
    with gr.Tab("Stock Info"):
        ...
        get_info_btn.click(fn=get_stock_info, inputs=stock_symbol_input, outputs=stock_info_output)
    ...
    with gr.Tab("Stock News"):
        ...
        get_news_btn.click(fn=get_stock_news, inputs=news_symbol_input, outputs=news_output)
